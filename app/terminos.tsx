...
const styles = StyleSheet.create({
  ...
  topbarTitle:    { flex: 1, textAlign: 'center', fontSize: 17, fontWeight: '900', color: '#111', letterSpacing: 0.3 },
  scroll:         { padding: 20, paddingTop: 8, paddingBottom: 40 },
  headerCard:     { flexDirection: 'row', alignItems: 'center', gap: 14, backgroundColor: '#111', borderRadius: 16, padding: 16, marginBottom: 16 },
  headerIcon:     { width: 44, height: 44, borderRadius: 14, backgroundColor: 'rgba(255,255,255,0.1)', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  ...
  intro:          { fontSize: 12.5, color: 'rgba(0,0,0,0.55)', lineHeight: 20, marginBottom: 18 },
  seccion:        { flexDirection: 'row', gap: 14, paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: 'rgba(0,0,0,0.06)' },
  seccionNum:     { width: 28, height: 28, borderRadius: 14, backgroundColor: 'rgba(143,204,0,0.12)', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: 1 },
  seccionNumTxt:  { fontSize: 12, fontWeight: '900', color: '#8FCC00' },
  seccionContent: { flex: 1 },
  seccionTitulo:  { fontSize: 14, fontWeight: '800', color: '#111', marginBottom: 6 },
  seccionCuerpo:  { fontSize: 13, color: 'rgba(0,0,0,0.55)', lineHeight: 20 },
  footer:         { marginTop: 24, textAlign: 'center', fontSize: 11, color: 'rgba(0,0,0,0.25)', lineHeight: 18 },
});
