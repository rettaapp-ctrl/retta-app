      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          <View style={styles.field}>
            <View style={styles.fieldIcon}>
              <Svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                <Path d="M20 21V19C20 17.9 19.1 17 18 17H6C4.9 17 4 17.9 4 19V21" stroke="rgba(0,0,0,0.3)" strokeWidth="1.8" strokeLinecap="round"/>
                <Circle cx="12" cy="9" r="4" stroke="rgba(0,0,0,0.3)" strokeWidth="1.8"/>
              </Svg>
            </View>
            <Text style={styles.fieldLabel}>Nombre</Text>
            <TextInput style={styles.fieldInput} value={nombre} onChangeText={setNombre} placeholder="Tu nombre" placeholderTextColor="rgba(0,0,0,0.25)"/>
          </View>
          ...
          <View style={styles.field}>
            ...
            <TextInput style={styles.fieldInput} value={apellido} onChangeText={setApellido} placeholder="Tu apellido" placeholderTextColor="rgba(0,0,0,0.25)"/>
          </View>
          ...
          <View style={styles.field}>
            <View style={styles.fieldIcon}>
              <Svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                <Path d="M4 4H20C21.1 4 22 4.9 22 6V18C22 19.1 21.1 20 20 20H4C2.9 20 2 19.1 2 18V6C2 4.9 2.9 4 4 4Z" stroke="rgba(0,0,0,0.3)" strokeWidth="1.8" strokeLinecap="round"/>
                <Path d="M22 6L12 13L2 6" stroke="rgba(0,0,0,0.3)" strokeWidth="1.8" strokeLinecap="round"/>
              </Svg>
            </View>
            <Text style={styles.fieldLabel}>Correo</Text>
            <TextInput style={styles.fieldInput} value={email} onChangeText={setEmail} placeholder="correo@ejemplo.com" keyboardType="email-address" autoCapitalize="none" placeholderTextColor="rgba(0,0,0,0.25)"/>
          </View>
          ...
          <View style={styles.field}>
            <View style={styles.fieldIcon}>
              <Svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                <Path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.62 3.42 2 2 0 0 1 3.59 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.55A16 16 0 0 0 16 16.09l.91-.91a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" stroke="rgba(0,0,0,0.3)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
              </Svg>
            </View>
            <Text style={styles.fieldLabel}>Teléfono</Text>
            <TextInput style={styles.fieldInput} value={telefono} onChangeText={setTelefono} placeholder="+52 55 0000 0000" keyboardType="phone-pad" placeholderTextColor="rgba(0,0,0,0.25)"/>
          </View>
          ...
          <View style={styles.field}>
            <View style={styles.fieldIcon}>
              <Svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                <Circle cx="12" cy="10" r="3" stroke="rgba(0,0,0,0.3)" strokeWidth="1.8"/>
                <Path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z" stroke="rgba(0,0,0,0.3)" strokeWidth="1.8"/>
              </Svg>
            </View>
            <Text style={styles.fieldLabel}>Ciudad</Text>
            <TextInput style={styles.fieldInput} value={ciudad} onChangeText={setCiudad} placeholder="Tu ciudad" placeholderTextColor="rgba(0,0,0,0.25)"/>
          </View>
          ...
          <View style={styles.field}>
            <View style={styles.fieldIcon}>
              <Svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                <Rect x="3" y="4" width="18" height="17" rx="3" stroke="rgba(0,0,0,0.3)" strokeWidth="1.8"/>
                <Path d="M8 2V6M16 2V6M3 9H21" stroke="rgba(0,0,0,0.3)" strokeWidth="1.8" strokeLinecap="round"/>
              </Svg>
            </View>
        ...
        <TouchableOpacity style={[styles.saveMain, saving && { opacity: 0.6 }]} onPress={handleSave} disabled={saving}>
          {saving
...
const styles = StyleSheet.create({
  ...
  backBtn:          { width: 36, height: 36, borderRadius: 10, backgroundColor: 'rgba(0,0,0,0.05)', alignItems: 'center', justifyContent: 'center', marginRight: 8 },
  ...
  saveBtnTxt:       { fontSize: 14, fontWeight: '800', color: COLORS.accent, letterSpacing: 0.3 },
  scroll:           { padding: 20, paddingTop: 8, paddingBottom: 40 },
  avatarBlock:      { alignItems: 'center', paddingVertical: 20, position: 'relative' },
  avatarRing:       { width: 90, height: 90, borderRadius: 45, backgroundColor: COLORS.accent, padding: 3, alignItems: 'center', justifyContent: 'center' },
  ...
  avatarEditBadge:  { position: 'absolute', top: 62, left: '50%', marginLeft: 18, width: 28, height: 28, borderRadius: 14, backgroundColor: '#111', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#fff' },
  avatarLabel:      { fontSize: 12, color: 'rgba(0,0,0,0.38)', marginTop: 10 },
  ...
  fieldDivider:     { height: 1, backgroundColor: 'rgba(0,0,0,0.05)', marginLeft: 16 },
  fieldIcon:        { width: 28, alignItems: 'center', marginRight: 10 },
  fieldLabel:       { width: 90, fontSize: 13, color: 'rgba(0,0,0,0.4)', fontWeight: '600', paddingRight: 8 },
  fieldInput:       { flex: 1, fontSize: 14, fontWeight: '700', color: '#111', paddingVertical: 0 },
  fieldReadonly:    { color: 'rgba(0,0,0,0.6)', paddingTop: Platform.OS === 'ios' ? 1 : 2 },
  toggleGroup:      { flexDirection: 'row', gap: 8 },
  toggleBtn:        { paddingHorizontal: 18, paddingVertical: 7, borderRadius: 20, backgroundColor: '#F2F1EF' },
  toggleBtnActive:  { backgroundColor: '#111' },
  toggleBtnTxt:     { fontSize: 13, fontWeight: '700', color: 'rgba(0,0,0,0.4)' },
  toggleBtnTxtActive: { color: '#fff' },
  sportSubLabel:    { fontSize: 12, fontWeight: '700', color: 'rgba(0,0,0,0.4)', marginBottom: 8 },
  chipGroup:        { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  chip:             { paddingHorizontal: 14, paddingVertical: 6, borderRadius: 20, backgroundColor: '#F2F1EF' },
  chipActive:       { backgroundColor: '#111' },
  chipTxt:          { fontSize: 13, fontWeight: '700', color: 'rgba(0,0,0,0.4)' },
  chipTxtActive:    { color: '#fff' },
  saveMain:         { backgroundColor: COLORS.accent, borderRadius: 16, height: 54, alignItems: 'center', justifyContent: 'center', marginTop: 4 },
  saveMainTxt:      { fontSize: 15, fontWeight: '900', color: '#0A0A0A', letterSpacing: 1.2 },
});
